...
def main():
    ...
    if args.dataset == "all":
        ...
        for name in dataset_names:
            path = f"exp2full_heads_mlp_neurons/datasets/{name}.jsonl"
        ...
        dataset_path = f"exp2full_heads_mlp_neurons/datasets/{args.dataset}.jsonl"
    ...
    os.makedirs("exp2full_heads_mlp_neurons/masks", exist_ok=True)
    mask_path = f"exp2full_heads_mlp_neurons/masks/{args.output_name}_mask.pt"
    ckpt_path = f"exp2full_heads_mlp_neurons/masks/{args.output_name}_checkpoint.pt"
