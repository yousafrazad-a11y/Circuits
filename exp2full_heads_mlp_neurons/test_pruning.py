...
def main():
    ...
    with open("exp2full_heads_mlp_neurons/categories.json", "r") as f:
        categories = json.load(f)
    fruits_set = categories["fruits"]
    
    ds = CategoryDataset("exp2full_heads_mlp_neurons/datasets/fruits.jsonl")
    ...
    # Save test mask
    manager.save_masks("exp2full_heads_mlp_neurons/masks/test_fruits_mask.pt")
