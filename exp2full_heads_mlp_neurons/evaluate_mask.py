...
def main():
    ...
    # Load categories
    cat_path = "exp2full_heads_mlp_neurons/categories.json"
    ...
    os.makedirs("exp2full_heads_mlp_neurons/results", exist_ok=True)
    output_path = os.path.join("exp2full_heads_mlp_neurons/results", args.output)
