...
Fixes for Dataset 7:
1. Implements "The object inside the [container]" logic to eliminate referential ambiguity.
2. Removes "The NonLiving Kitchen" as it was the worst performing theme in Dataset 2.
"""
...
def generate_prompts(entities: List[str], theme_name: str) -> dict:
    ...
    clean_p = (
        ...
        f"The object inside the {mobile_c} is moved to the {outer1}. "
        f"The object inside the {outer1} is moved to the {outer2}. "
...
def main():
    ...
    parser.add_argument("--output", type=str, default="/home/exouser/pruning/datasets/dataset7.jsonl")
