...
same CSV columns). Run from repo root:
    ...
    venv/bin/python intersection_experiments_4/eval_all.py \
        --mask intersection_experiments_4/masks/intersection_600.pt \
...
def main():
    ...
    os.makedirs("intersection_experiments_4/results", exist_ok=True)
    output_path = os.path.join("intersection_experiments_4/results", args.output)
    ...
    with open(output_path, 'w', newline='') as f:
        ...
        for ds_name in DATASETS:
            ds_path = f"intersection_experiments_4/datasets/{ds_name}.jsonl"
