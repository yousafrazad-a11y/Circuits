...
Run from repo root:
    venv/bin/python intersection_experiments_4/gen_anti_mlp.py
"""
import os
import sys
import json
...
N_EXAMPLES = 10
GEN_TOKENS = 12
OUT_PATH = "intersection_experiments_4/results/anti_mlp_generation.txt"
...
def main():
    ...
    with open(OUT_PATH, 'w') as f:
        for cat in CATS:
            src = f"intersection_experiments_4/masks/frozen_{cat}_300ep_l005_mask.pt"
            anti_path = build_anti_mlp(src, f"intersection_experiments_4/masks/anti_mlp_{cat}.pt")
