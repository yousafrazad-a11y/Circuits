...
Run from repo root:
    venv/bin/python intersection_experiments_4/error_analysis.py
"""
import os
import sys
import json
...
MASKS = {
    "heads_intersection (47)": "intersection_experiments_4/masks/intersection_frozen_heads_only.pt",
    "fruits_heads_only (94)": "intersection_experiments_4/masks/fruits_heads_only.pt",
}
DATASETS = ["fruits_2", "animals_2", "colors_2", "metals_2", "vehicles_2"]
N_EXAMPLES = 20
GEN_TOKENS = 3
OUT_PATH = "intersection_experiments_4/results/error_analysis.txt"
