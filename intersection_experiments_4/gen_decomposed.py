...
Run from repo root:
    venv/bin/python intersection_experiments_4/gen_decomposed.py
"""
import os
import sys
import random
...
BASE_MASK = "intersection_experiments_4/masks/frozen_fruits_300ep_l005_mask.pt"
DATASETS = ["fruits_2", "animals_2", "colors_2", "metals_2", "vehicles_2",
            "clothing_2", "sports_2"]
N_EXAMPLES = 5
GEN_TOKENS = 12
OUT_PATH = "intersection_experiments_4/results/decomposed_generation.txt"
...
def build_variants():
    ...
    for k, v in mask.items():
        if 'head_gates' in k:
            ...
            mlp_only[k] = v.clone()
    h_path = "intersection_experiments_4/masks/fruits_heads_only.pt"
    m_path = "intersection_experiments_4/masks/fruits_mlp_only.pt"
