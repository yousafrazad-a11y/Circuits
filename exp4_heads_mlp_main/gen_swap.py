...
Run from repo root:
    venv/bin/python exp4_heads_mlp_main/gen_swap.py
"""
import os
import sys
import json
...
FRUITS = "exp4_heads_mlp_main/masks/frozen_fruits_300ep_l005_mask.pt"
COLORS = "exp4_heads_mlp_main/masks/frozen_colors_300ep_l005_mask.pt"
DATASETS = ["fruits_2", "animals_2", "vehicles_2", "colors_2"]
N_EXAMPLES = 5
GEN_TOKENS = 20
OUT_PATH = "exp4_heads_mlp_main/results/swap_generation.txt"
...
def main():
    ...
    masks = {
        "fruitsH_colorsM": build_hybrid(FRUITS, COLORS, "exp4_heads_mlp_main/masks/swap_fruitsH_colorsM.pt"),
        "fruitsH_fruitsM (control)": FRUITS,
        "colorsH_colorsM (control)": COLORS,
        "colorsH_fruitsM": build_hybrid(COLORS, FRUITS, "exp4_heads_mlp_main/masks/swap_colorsH_fruitsM.pt"),
    }
