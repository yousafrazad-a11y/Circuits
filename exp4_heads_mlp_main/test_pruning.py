...
def main():
    ...
    with open("exp4_heads_mlp_main/categories.json", "r") as f:
        categories = json.load(f)
    fruits_set = categories["fruits"]
    
    ds = CategoryDataset("exp4_heads_mlp_main/datasets/fruits.jsonl")
    ...
    # Save test mask
    manager.save_masks("exp4_heads_mlp_main/masks/test_fruits_mask.pt")
