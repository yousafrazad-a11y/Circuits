...
same CSV columns). Run from repo root:
    ...
    venv/bin/python exp4_heads_mlp_main/eval_all.py \
        --mask exp4_heads_mlp_main/masks/intersection_600.pt \
...
def main():
    ...
    os.makedirs("exp4_heads_mlp_main/results", exist_ok=True)
    output_path = os.path.join("exp4_heads_mlp_main/results", args.output)
    ...
    with open(output_path, 'w', newline='') as f:
        ...
        for ds_name in DATASETS:
            ds_path = f"exp4_heads_mlp_main/datasets/{ds_name}.jsonl"
