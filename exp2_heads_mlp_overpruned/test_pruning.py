...
def main():
    ...
    with open("exp2_heads_mlp_overpruned/categories.json", "r") as f:
        categories = json.load(f)
    fruits_set = categories["fruits"]
    
    ds = CategoryDataset("exp2_heads_mlp_overpruned/datasets/fruits.jsonl")
    ...
    # Save test mask
    manager.save_masks("exp2_heads_mlp_overpruned/masks/test_fruits_mask.pt")
