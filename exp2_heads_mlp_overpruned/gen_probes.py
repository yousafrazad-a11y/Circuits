...
Run from repo root:
    venv/bin/python exp2_heads_mlp_overpruned/gen_probes.py
"""
import os
import sys
import json
...
MASKS = {
    "intersection_frozen_300_300": "exp2_heads_mlp_overpruned/masks/intersection_frozen_300_300.pt",
    "intersection_600": "exp2_heads_mlp_overpruned/masks/intersection_600.pt",
    "anti_intersection_frozen_300_300": "exp2_heads_mlp_overpruned/masks/anti_intersection_frozen_300_300.pt",
    "anti_intersection_600": "exp2_heads_mlp_overpruned/masks/anti_intersection_600.pt",
}
...
N_EXAMPLES = 10
GEN_TOKENS = 20
OUT_PATH = "exp2_heads_mlp_overpruned/results/generation_probes.txt"
...
def main():
    ...
    for ds_name in DATASETS:
        ds = CategoryDataset(f"exp2_heads_mlp_overpruned/datasets/{ds_name}.jsonl")
