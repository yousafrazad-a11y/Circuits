...
class CircuitPruningManager:
    ...
    def _get_default_config(self) -> PruningConfig:
        """
        By default, only attention heads pruning is enabled.
        All other components are set to False.
        """
        config = PruningConfig()
        config.prune_attention_heads = True
        config.prune_mlp_hidden = False
        config.prune_mlp_output = False
        config.prune_attention_neurons = False
