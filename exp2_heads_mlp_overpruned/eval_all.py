...
same CSV columns). Run from repo root:
    ...
    venv/bin/python exp2_heads_mlp_overpruned/eval_all.py \
        --mask exp2_heads_mlp_overpruned/masks/intersection_600.pt \
...
def main():
    ...
    with open("exp2_heads_mlp_overpruned/categories.json") as f:
    ...
    os.makedirs("exp2_heads_mlp_overpruned/results", exist_ok=True)
    output_path = os.path.join("exp2_heads_mlp_overpruned/results", args.output)
    ...
    with open(output_path, 'w', newline='') as f:
        ...
        for ds_name in DATASETS:
            ds_path = f"exp2_heads_mlp_overpruned/datasets/{ds_name}.jsonl"
