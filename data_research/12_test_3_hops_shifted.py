...
for i in range(5):
    ...
    actors = living_actors[i:i+5] 
    
    clean = f"The {o1} is given to the {actors[0]}. The {actors[0]} hands it to the {actors[2]}. The {actors[2]} hands it to the {actors[3]}. The {actors[3]} hands it to the {actors[4]}. The {o2} is given to the {actors[1]}. The {o1} is held by the"
    c_target = actors[4]
    
    corr = f"The {o2} is given to the {actors[0]}. The {actors[0]} hands it to the {actors[2]}. The {actors[2]} hands it to the {actors[3]}. The {actors[3]} hands it to the {actors[4]}. The {o1} is given to the {actors[1]}. The {o1} is held by the"
...
for i in range(5):
    ...
    clean = f"The {o1} is put in the {places[0]}. The {places[0]} is moved to the {places[2]}. The {places[2]} is moved to the {places[3]}. The {places[3]} is moved to the {places[4]}. The {o2} is put in the {places[1]}. The {o1} is located in the"
    c_target = places[4]
    
    corr = f"The {o2} is put in the {places[0]}. The {places[0]} is moved to the {places[2]}. The {places[2]} is moved to the {places[3]}. The {places[3]} is moved to the {places[4]}. The {o1} is put in the {places[1]}. The {o1} is located in the"
...
for model, data in results.items():
    ...
    for item in data:
        ...
        if t == "corr":
            ...
            print(f"[{cat.upper()}] Target: {target} | Predicted: {top1} ({top1_prob:.2f}), {top2} ({top2_prob:.2f})")
