...
MODELS = {
    ...
    "deepseek": {
        ...
        "quant": None # vLLM auto-detects w8a8 natively via config.json
    }
}
...
def main():
    ...
    input_file = "/home/exouser/pruning/datasets/dataset3.jsonl"
    ...
    final_summary_path = "/home/exouser/pruning/datasets/dataset3_accuracy_summary.json"
