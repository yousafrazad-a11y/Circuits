...
def main():
    ...
    with open("exp3_dual_init_union/categories.json", "r") as f:
        categories = json.load(f)
    fruits_set = categories["fruits"]
    
    ds = CategoryDataset("exp3_dual_init_union/datasets/fruits.jsonl")
    ...
    # Save test mask
    manager.save_masks("exp3_dual_init_union/masks/test_fruits_mask.pt")
