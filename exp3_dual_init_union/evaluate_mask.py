...
def main():
    ...
    # Load categories
    cat_path = "exp3_dual_init_union/categories.json"
    ...
    dataset_path = f"exp3_dual_init_union/datasets/{args.dataset}.jsonl"
    ...
    os.makedirs("exp3_dual_init_union/results", exist_ok=True)
    output_path = os.path.join("exp3_dual_init_union/results", args.output)
