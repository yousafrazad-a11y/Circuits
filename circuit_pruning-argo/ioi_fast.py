...
#     lambda_attention_heads: float = 0.4 * PRUNING_FACTOR 
...
class PruningConfig:
    ...
    # Individual neurons are weak. The penalty must be small, or you kill them all.
    prune_mlp_hidden: bool = True
    lambda_mlp_hidden: float = 1.0 * PRUNING_FACTOR  # Much lower than 25.0!
