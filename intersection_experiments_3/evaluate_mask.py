...
def main():
    ...
    # Load categories
    cat_path = "intersection_experiments_3/categories.json"
    ...
    dataset_path = f"intersection_experiments_3/datasets/{args.dataset}.jsonl"
    ...
    os.makedirs("intersection_experiments_3/results", exist_ok=True)
    output_path = os.path.join("intersection_experiments_3/results", args.output)
