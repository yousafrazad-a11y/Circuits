...
def main():
    ...
    with open("intersection_experiments_3/categories.json", "r") as f:
        categories = json.load(f)
    fruits_set = categories["fruits"]
    
    ds = CategoryDataset("intersection_experiments_3/datasets/fruits.jsonl")
    ...
    # Save test mask
    manager.save_masks("intersection_experiments_3/masks/test_fruits_mask.pt")
