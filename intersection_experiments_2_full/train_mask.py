...
def main():
    ...
    if args.dataset == "all":
        ...
        for name in dataset_names:
            path = f"intersection_experiments_2_full/datasets/{name}.jsonl"
    ...
    os.makedirs("intersection_experiments_2_full/masks", exist_ok=True)
    mask_path = f"intersection_experiments_2_full/masks/{args.output_name}_mask.pt"
    ckpt_path = f"intersection_experiments_2_full/masks/{args.output_name}_checkpoint.pt"
